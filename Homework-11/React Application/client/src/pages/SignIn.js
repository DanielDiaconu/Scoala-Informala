      ...
      <div className="container">
        ...
        >
          <div className="col-6 d-flex justify-content-center align-items-center flex-column text-center register-info">
            <h1>Welcome Back!</h1>
            <p>
              To keep connected with us please login with your personal info If
              you dont have an account please create one{" "}
          ...
          <div className="col-6 register-form">
            ...
            <form className="d-flex flex-column align-items-center">
              ...
              <input
                ...
                onChange={onInputChange}
              />
              <button type="submit" className="sign-up" onClick={handleSubmit}>
                LOGIN
              </button>
            </form>
          </div>
